...
public class AdminBoardVO {
	...
	public String toString() {
		return "AdminBoardVO [id=" + id + ", title=" + title + ", contents=" + contents + ", file_name=" + file_name + ", save_route=" + save_route 
				+ ", short_comment=" + short_comment + ", cnt=" + cnt + ", registered_id=" + registered_id + ", updated_id=" + updated_id 

					...
					<div class="row" >
						<div class="col-md-12">
							<form role="form" method="post" class="search-form">
								...
								<button type="button" class="btn btn-list-insert" onclick="location.href='/carwash/user/free/insert'">등록</button>
					...
					<table class="table text-center">
						...
						<tbody>
							<c:forEach var="list" items="${list}" varStatus="i">
								<tr>
									<td>${list.id }</td>
									<td class="ellipsis"><a href="/carwash/user/free/read?id=${list.id }">${list.title }</a>
										<a href="#"><span class="label-bold" style="margin-left: 5px;">[${list.reply_cnt }]</span></a>
							...
							<div class="width-div">
								<ul class="pagination pagination-sm" style="justify-content: center;">
									<c:if test="${pageMaker.prev}">
										<li class="page-item"><a class="page-link" href="/carwash/user/free/list?page=${pageMaker.startPage - 1 }&search=${search}&type=${type}">&laquo;</a></li>
									</c:if>
									<c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage}" var="page">
										<li class="page-item"><a class="page-link" href="/carwash/user/free/list?page=${page }&search=${search}&type=${type}">${page }</a></li>
									</c:forEach>
									<c:if test="${pageMaker.next}">
										<li class="page-item"><a class="page-link" href="/carwash/user/free/list?page=${pageMaker.endPage + 1 }&search=${search}&type=${type}">&raquo;</a></li>
									</c:if>
								</ul>
							</div>
						</div>

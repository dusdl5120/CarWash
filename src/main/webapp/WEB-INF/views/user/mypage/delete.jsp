...
<body>
	...
	<div class="container">
		...
		<form method="post" class="form" id="form" action="/carwash/user/member/myDelete"> 
			<div class="form-div">
			 	
			 	<input type="hidden" id="userId" name="user_id" value="${my.user_id }"/>
				...
				<div class="row form-row"> 
					...
					<div class="col-md-2 text-left"> 
						<input type="password" class="input form-control mydelete-form" id="user_passwd" name="user_passwd">
					</div>

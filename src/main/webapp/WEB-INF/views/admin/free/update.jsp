		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4" style="text-align: center;">
					<h4 class="modal-titles fa fa-list">&nbsp;&nbsp;<strong>자유게시판 수정</strong>
					</h4>
				</div>
				<div class="col-md-4"></div>
			...
			<form method="post">
				...
				<input type="hidden" name="id" value="${board.id }" />
	                ...
	                <div class="form-group">
	                    <label class="col-md-4 control-label">파일첨부</label>
	                    <div class="col-md-8">                                            
	                        <div class="input-group">
	                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
	                            <textarea class="form-control" name="file_name">${board.file_name }</textarea>
	                        </div>                                            
	                    </div>
	                </div>

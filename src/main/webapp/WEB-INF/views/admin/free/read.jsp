			...
			<form>
				<div style="margin-right: 80px;">
					...
					<div class="form-group" style="display: inline-flex;">
						<label class="col-md-12 control-label">작성자 : </label> <label
							for="registered_id">${board.registered_id }</label>
					</div>
					<br>

					<div class="form-group" style="display: inline-flex;">
						<label class="col-md-12 control-label">제목 : </label> <label
							for="title">${board.title }</label>
					</div>
					<br>

					<div class="form-group" style="display: inline-flex;">
						<label class="col-md-12 control-label">내용 : </label> <label
							for="contents">${board.contents }</label>
					</div>
					<br>

					<div class="form-group" style="display: inline-flex;">
						<label class="col-md-12 control-label">조회수 : </label> <label
							for="contents">${board.cnt }</label>
					</div>
					<br>

					<div class="form-group" style="display: inline-flex;">
						<label class="col-md-12 control-label">파일첨부 : </label> <label
							for="contents">${board.file_name }</label>
					</div>
					<br>

...
<%-- 				<p class="m-0 text-right text-white">페이스북<img src="<c:url value='/resources/images/facebook.png' />"></p>
			...
			<div class="col-md-4"> 
				...
				<p class="m-0 text-center text-white">이메일 : carwash@carwash.com</p>
			</div>
			<div class="col-md-3"> 
				<p class="m-0 text-left text-white">충북 청주시 서원구 사창동 123-12 </p>
				<p class="m-0 text-left text-white">대표자명 : 카워시 </p>
				<p class="m-0 text-left text-white">사업자번호 : 123-45-6789 </p>
			</div>
			<div class="col-md-1"></div>
		</div>
		<br> <br>
